// ByClassName
const header = document.getElementsByClassName("header"); //Obtener elementos por clase
console.log(header);
...
// ById
const form = document.getElementById("idf-1");  // Nos 
console.log(form);
...
const nav_item2 = document.querySelector(".collapse .nav-item:nth-child(2)"); //Traerme el segundo hijo del elemento
...
//seleccionar por tag -- > nos trae los que tengan est
const nav = document.querySelector("nav"); 
console.log(nav);

// querySelectorALL  ---> Nos trae todos
